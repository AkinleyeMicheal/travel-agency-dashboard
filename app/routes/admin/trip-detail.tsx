...
import { Header, InfoPill, TripsCard } from "~/components";
import {
  ChipDirective,
  ChipListComponent,
  ChipsDirective,
...
const TripDetail = ({ loaderData }: Route.ComponentProps) => {
  ...
  const visitTimeAndWeatherInfo = [
    ...
    { title: "Most suitable clothes to wear", items: weatherInfo },
  ];
  ...
  return (
    <main className="travel-detail wrapper">
      ...
      <section className="container wrapper-md">
        ...
        <p className="text-sm md:text-lg font-normal text-dark-500">
          {description}
        </p>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="p-24-bold text-dark-100">Popular Trips</h2>
